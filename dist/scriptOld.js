...
var handlers = {
  ...
  setDisplay: function setDisplay(digit) {
    inputDisplay.textContent = digit;
  },
  addToDisplay: function addToDisplay(digit) {
    inputDisplay.textContent += digit;
  },
